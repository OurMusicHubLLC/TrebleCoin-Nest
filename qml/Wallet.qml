...
Rectangle {
    ...
    Rectangle {
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive TRBL"
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " TRBL + " + rectangleTransfer.transferFee + " (fee) + " + rectangleTransfer.nodeFeeValue + " (node fee)", rectangleTransfer.transferPaymentID);
            }
        }
